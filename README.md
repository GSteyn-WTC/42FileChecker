...
* When running the `leaks` test for the first time, a box will apear and prompt you for administrator username and password. Enter `exam` and `exam` and everything will go along
